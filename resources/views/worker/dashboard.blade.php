                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end pe-4">
                                                @if($foglalas->statuszok_id == 1)
                                                    ...
                                                    {{-- MODAL: ELUTASÍTÁS MEGERŐSÍTÉSE --}}
                                                    <div class="modal fade text-start" id="rejectModal{{ $foglalas->id }}" tabindex="-1" aria-hidden="true">
