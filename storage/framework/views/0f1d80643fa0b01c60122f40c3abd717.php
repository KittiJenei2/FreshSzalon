...
<div class="position-relative mb-5">
    <div style="height: 300px; overflow: hidden; background-color: #333;">
        <img src="<?php echo e(asset('images/kellekek.jpg')); ?>" class="w-100 h-100" style="object-fit: cover; filter: brightness(0.6);" alt="Termékeink">
    </div>
...
<div class="container pb-5">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-5 bg-light">
        <div class="card-body p-4">
            <form action="<?php echo e(route('termekek.index')); ?>" method="GET" class="row g-3 align-items-end" id="szuroForm">
                ...
                <div class="col-md-3 d-flex gap-2" id="szuroGombok">
                    ...
                    <?php if(request()->filled('kereses') || request()->filled('kategoria')): ?>
                        <a href="<?php echo e(route('termekek.index')); ?>" class="btn btn-outline-danger btn-lg rounded-pill px-3 reset-btn" title="Szűrők törlése">✖</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
    ...
    <div id="talalatokContainer" style="transition: opacity 0.3s ease;">
        ...
        <?php $__currentLoopData = $csoportositottTermekek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategoriaNev => $termekekCsoport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="mb-5">
                ...
                <div class="row g-4">
                    <?php $__currentLoopData = $termekekCsoport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $termek): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card h-100 border-0 shadow-sm product-card hover-elevate">
                                <div class="card-body p-4 d-flex flex-column">
                                    <div class="mb-3">
                                        ...
                                        <h4 class="card-title fw-bold text-primary mb-0"><?php echo e($termek->nev); ?></h4>
                                    </div>
                                    <p class="card-text text-muted mb-4 flex-grow-1">
                                        <?php echo e($termek->leiras ?? 'Ehhez a termékhez még nincs részletes leírás.'); ?>
                                    ...
                                    <div class="mt-auto d-flex align-items-center justify-content-between border-top pt-3">
                                        <div>
                                            ...
                                            <span class="fw-bold fs-4"><?php echo e(number_format($termek->ar, 0, ',', ' ')); ?> Ft</span>
                                        </div>
        ...
        <?php if($termekek->isEmpty()): ?>
            <div class="alert alert-warning text-center p-5 rounded-4 shadow-sm mb-5">
                ...
                <?php if(request()->filled('kereses') || request()->filled('kategoria')): ?>
                    <a href="<?php echo e(route('termekek.index')); ?>" class="btn btn-outline-dark rounded-pill px-4 mt-4 reset-btn">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\FreshSzalon-master\resources\views/termekek/index.blade.php ENDPATH**/ ?>