        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-body p-4 text-center">
                    ...
                    <h4 class="fw-bold mb-1"><?php echo e($felhasznalo->nev); ?></h4>
                    <p class="text-muted mb-4">Regisztrált felhasználó</p>
                    
                    <ul class="list-group list-group-flush text-start mb-4">
                        <li class="list-group-item border-0 px-0">
                            <strong>Email:</strong> <br> <?php echo e($felhasznalo->email); ?>

                        </li>
                        <li class="list-group-item border-0 px-0">
                            <strong>Telefon:</strong> <br> <?php echo e($felhasznalo->telefonszam); ?>
                    ...
                    <div class="mb-4 p-3 bg-light rounded-3 text-start">
                        ...
                        <div class="mb-1">
                            <span class="badge <?php echo e($felhasznalo->foglalhat ? 'bg-success' : 'bg-danger'); ?> p-2 w-100">
                                Időpontfoglalás: <?php echo e($felhasznalo->foglalhat ? 'Engedélyezve' : 'Tiltva'); ?>

                            </span>
                        </div>
                        <div>
                            <span class="badge <?php echo e($felhasznalo->velemenyt_irhat ? 'bg-success' : 'bg-danger'); ?> p-2 w-100">
                                Véleményírás: <?php echo e($felhasznalo->velemenyt_irhat ? 'Engedélyezve' : 'Tiltva'); ?>

                            </span>
                        </div>
                    </div>

                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-primary rounded-pill w-100 fw-bold">
                        Adataim módosítása
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-5">
                <div class="card-body p-0">
                    <?php if($aktualis_foglalasok->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $aktualis_foglalasok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
                                        <tr class="<?php echo e($f->statuszok_id == 3 ? 'bg-light' : ''); ?>" style="transition: background-color 0.3s ease;">
                                            
                                            
                                            <td class="fw-bold <?php echo e($f->statuszok_id == 3 ? 'opacity-50' : ''); ?>"><?php echo e($f->datum); ?></td>
                                            <td class="<?php echo e($f->statuszok_id == 3 ? 'opacity-50' : ''); ?>"><?php echo e(substr($f->ido_kezdes, 0, 5)); ?></td>
                                            <td class="<?php echo e($f->statuszok_id == 3 ? 'opacity-50' : ''); ?>"><?php echo e($f->szolgaltatas->nev); ?></td>
                                            <td class="<?php echo e($f->statuszok_id == 3 ? 'opacity-50' : ''); ?>"><?php echo e($f->dolgozo->nev); ?></td>
                                            <td class="<?php echo e($f->statuszok_id == 3 ? 'opacity-50' : ''); ?>">
                                                
                                                <?php
                                                    $badgeClass = 'bg-warning text-dark'; // Alapértelmezett: Függőben
                                                    if($f->statuszok_id == 2) $badgeClass = 'bg-success';      // Elfogadva
                                                    if($f->statuszok_id == 3) $badgeClass = 'bg-danger';       // Elutasítva
                                                    if($f->statuszok_id == 4) $badgeClass = 'bg-primary';      // Elvégezve
                                                ?>

                                                <span class="badge rounded-pill <?php echo e($badgeClass); ?>">
                                                    <?php echo e($f->statusz->nev ?? 'Függőben'); ?>
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="d-flex justify-content-end gap-2">
                                                    ...
                                                    <?php if($f->statuszok_id == 3): ?>
                                                        <?php
                                                            // Lekérdezzük, hogy az adott napon szabadságon van-e a dolgozó
                                                            $szabadsagMiatta = App\Models\Szabadsagok::where('dolgozo_id', $f->dolgozo_id)
                                                                ->where('datum_kezdes', '<=', $f->datum)
                                                                ->where('datum_vege', '>=', $f->datum)
                                                                ->first();
                                                        ?>
                                                        <div class="mt-2 text-danger small" style="min-width: 150px;">
                                                            <?php if($szabadsagMiatta): ?>
                                                                <i class="fw-bold">Szabadság miatt törölve!</i><br>
                                                                <span class="text-muted">(<?php echo e($szabadsagMiatta->datum_kezdes); ?> / <?php echo e($szabadsagMiatta->datum_vege); ?>)</span><br>
                                                            <?php else: ?>
                                                                <i class="fw-bold">Sajnáljuk, ez az időpont betelt!</i><br>
                                                                Kérünk, válassz másikat!
                                                            <?php endif; ?>
                                                            
                                                            <div class="mt-1">
                                                                <a href="<?php echo e(route('idopontfoglalas.index')); ?>" class="btn btn-sm btn-outline-danger py-0 px-2 fw-bold" style="font-size: 0.7rem;">
                                                                    Új foglalás →
                                                                </a>
                                                            </div>
                                                        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-body p-0">
                    <?php if($korabbi_foglalasok->isEmpty()): ?>
                        <div class="p-4 text-center text-muted">
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $korabbi_foglalasok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-muted fw-bold"><?php echo e($f->datum); ?></td>
                                            <td><?php echo e($f->szolgaltatas->nev); ?></td>
                                            <td><?php echo e($f->dolgozo->nev); ?></td>
                                            <td class="text-center">
                                                <?php if($f->velemeny): ?>
                                                    <div class="text-warning" title="<?php echo e($f->velemeny->velemeny); ?>">
                                                        <?php for($i = 0; $i < $f->velemeny->ertekeles; $i++): ?> ★ <?php endfor; ?>
                                                        <?php for($i = $f->velemeny->ertekeles; $i < 5; $i++): ?> ☆ <?php endfor; ?>
                                                    </div>
                                                <?php else: ?>
                                                    
                                                    <?php if($felhasznalo->velemenyt_irhat == 1): ?>
                                                        <button class="btn btn-outline-primary btn-sm rounded-pill feedbackBtn px-3"
                                                                data-bs-toggle="modal" 
                                                                data-bs-target="#feedbackModal"
                                                                data-id="<?php echo e($f->id); ?>"
                                                                data-szolgaltatas="<?php echo e($f->szolgaltatas->nev); ?>">
                                                            Értékelés
                                                        </button>
                                                    <?php else: ?>
...
<div class="modal fade" id="feedbackModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form action="<?php echo e(route('profile.feedback.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\FreshSzalon-master\resources\views/profile/index.blade.php ENDPATH**/ ?>