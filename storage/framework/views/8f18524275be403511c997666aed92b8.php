...
<div class="position-relative mb-5">
    <div style="height: 250px; overflow: hidden;">
        <img src="<?php echo e(asset('images/kellekek.jpg')); ?>" class="w-100 h-100" style="object-fit: cover; filter: brightness(0.6);" alt="Időpontfoglalás">
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-lg rounded-3 overflow-hidden">
                ...
                <div class="card-body p-4 p-lg-5">
                    ...
                    <?php if(Auth::check() && Auth::user()->foglalhat == 0): ?>
                    ...
                    <form id="bookingForm">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg shadow-sm border-0 bg-light" id="lehetoseg_id" name="lehetoseg_id" required>
                                ...
                                <?php $__currentLoopData = $lehetosegek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lehetoseg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lehetoseg->id); ?>"><?php echo e($lehetoseg->nev); ?></option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\FreshSzalon-master\resources\views/idopontfoglalas/index.blade.php ENDPATH**/ ?>